...
public class MQClientAPIImplInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String ASYNC_METHOD_INTERCEPTOR = "org.apache.skywalking.apm.plugin.aliyunrocketmq.MessageSendInterceptor";
    public static final String UPDATE_NAME_SERVER_INTERCEPT_CLASS = "org.apache.skywalking.apm.plugin.aliyunrocketmq.UpdateNameServerInterceptor";
