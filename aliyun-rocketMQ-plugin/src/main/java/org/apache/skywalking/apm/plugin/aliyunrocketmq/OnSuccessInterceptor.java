...
//        System.out.println("[callback:]运行到这里");
        SendCallBackEnhanceInfo enhanceInfo = (SendCallBackEnhanceInfo) objInst.getSkyWalkingDynamicField();
//        System.out.println("[callback:]运行到这里2:" + enhanceInfo);
//        System.out.println("[callback:]运行到这里2.1:" + enhanceInfo.getTopicId());
        ...
        activeSpan.setComponent(ComponentsDefine.ALIYUN_ROCKET_MQ_PRODUCER);
//        System.out.println("[callback:]运行到这里3");
...
//        System.out.println("[callback:]运行到这里4");
    }
