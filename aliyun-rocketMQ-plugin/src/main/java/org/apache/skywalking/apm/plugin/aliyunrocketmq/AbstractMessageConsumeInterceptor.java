...
public abstract class AbstractMessageConsumeInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    public final void beforeMethod(EnhancedInstance objInst, Method method, Object[] allArguments,
        ...
        AbstractSpan span = ContextManager.createEntrySpan(CONSUMER_OPERATION_NAME_PREFIX + msgs.get(0).getTopic()
                + "/" + msgs.get(0).getTags() + "/Consumer", contextCarrier);
...
//            System.out.println("[consumer:" + next.getHeadKey() + "]" + message.getUserProperty(next.getHeadKey()));
        }
